...
<div class="row row-overflow">
  ...
  <legend><i class="fa fa-table"></i> {{Mes anaclocks}}</legend>
<div class="eqLogicThumbnailContainer">
    <?php
    ...
    <form class="form-horizontal">
        <fieldset>
            <div class="form-group">
                <label class="col-sm-3 control-label">{{Nom de l'équipement anaclock}}</label>
                <div class="col-sm-3">
                    <input type="text" class="eqLogicAttr form-control" data-l1key="id" style="display : none;" />
                    <input type="text" class="eqLogicAttr form-control" data-l1key="name" placeholder="{{Nom de l'équipement anaclock}}"/>
                </div>
            </div>
            <div class="form-group">
...
?>
	...
	<div class="form-group">
       ...
       <div class="form-group">
        <label class="col-sm-3 control-label">{{anaclock param 1}}</label>
        <div class="col-sm-3">
...
<?php include_file('desktop', 'anaclock', 'js', 'anaclock');?>
